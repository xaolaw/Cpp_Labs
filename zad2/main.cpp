...
constexpr const char* const FIRSTNAME = "Adam";
constexpr const char* const SURNAME   = "Cwikla";
constexpr const char* const MAIL    = "adamcwikla@student.agh.edu.pl";
constexpr const char* const BOOK_ID = "406422";
...
int main()
{
    ...
    TwoDimensionMatrix* test=new TwoDimensionMatrix();
    std::cout<<"test";
}
